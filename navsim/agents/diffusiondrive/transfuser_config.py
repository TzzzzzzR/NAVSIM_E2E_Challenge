...
class TransfuserConfig:
    ...
    bkb_path: str = "/fsave/tuzhirui/NAVSIM_v2.2/navsim/navsim/agents/diffusiondrive/pytorch_model.bin"
    plan_anchor_path: str = "/fsave/tuzhirui/NAVSIM_v2.2/navsim/navsim/agents/diffusiondrive/kmeans_navsim_traj_20.npy"
    ...
    bev_semantic_classes = {
        1: ("polygon", [SemanticMapLayer.LANE, SemanticMapLayer.INTERSECTION]),  # road 车道、交叉路口
        2: ("polygon", [SemanticMapLayer.WALKWAYS]),  # walkways 人行道
        3: ("linestring", [SemanticMapLayer.LANE, SemanticMapLayer.LANE_CONNECTOR]),  # centerline 车道线，车道连接线
        4: (
            "box",
            [
                TrackedObjectType.CZONE_SIGN,   # 交通标志
                TrackedObjectType.BARRIER,      # 障碍物
                TrackedObjectType.TRAFFIC_CONE,  # 交通锥
                TrackedObjectType.GENERIC_OBJECT, # 一般物体
            ],
        ),  # static_objects
        5: ("box", [TrackedObjectType.VEHICLE]),  # vehicles 车辆
        6: ("box", [TrackedObjectType.PEDESTRIAN]),  # pedestrians 行人
    }
