wget https://hf-mirror.com/datasets/OpenDriveLab/OpenScene/resolve/main/navsim-v2/navsim_v2.2_private_test_hard_two_stage.tar.gz
tar -xzf navsim_v2.2_private_test_hard_two_stage.tar.gz
rm navsim_v2.2_private_test_hard_two_stage.tar.gz

wget https://hf-mirror.com/datasets/OpenDriveLab/OpenScene/resolve/main/openscene-v1.1/openscene_sensor_private_test_hard.tar.gz
...
wget https://hf-mirror.com/datasets/OpenDriveLab/OpenScene/resolve/main/openscene-v1.1/openscene_metadata_private_test_hard.tar.gz
